      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className={`grid lg:grid-cols-2 gap-4 md:gap-6 items-end ${isReversed ? 'lg:grid-flow-col-dense' : ''}`}>
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-50px" }}
            className={`${isReversed ? 'lg:col-start-1 lg:mr-[-30px]' : 'lg:ml-[-30px]'} h-[280px] sm:h-[320px] md:h-[360px] lg:h-[400px] flex flex-col justify-end relative z-20 mt-[20%] md:mt-[-60px] w-full max-w-[95%] mx-auto lg:max-w-none`}
          >
